...
//				break;
	...
	private class ALPDAdapter extends RecyclerView.Adapter {
		...
		public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
			return new ALPDViewHolder(LayoutInflater.from(MainActivity.this).inflate(
					R.layout.image_meta, parent, false));
		}
		...
		public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
			...
			if (onALPDClickListener != null) {
				holder.itemView.setOnClickListener(view ->
						onALPDClickListener.onClick(view,
								position, ((ALPDViewHolder) holder).getID()));
				holder.itemView.setOnTouchListener((view, motionEvent) ->
						onALPDClickListener.onTouch(view,
								position, ((ALPDViewHolder) holder).getID()));
				holder.itemView.setOnLongClickListener(view ->
						onALPDClickListener.onLongClick(view,
								position, ((ALPDViewHolder) holder).getID()));
			}
		}
